...
# my $home="/home/fcalvet/Desktop/uORFs";
my $home="../..";

my $default_output = "$home/DATA/raw_data/raw_uORFs/uORFs_defaultOUT";

if (!defined $output_filename) {
   system "mkdir -p ${default_output}";
...
HAVANA / Vertebrate Genomics team
...
# Parallel::ForkManager module written by Balázs Szabó
https://metacpan.org/pod/Parallel::ForkManager#COPYRIGHT-AND-LICENSE
...
# always check that the error file you generate is empty, and you can also check that the stats file has all the input IDs
...
# Run sequentially when trying if the changes in the code work. # you might use a smaller input to avoid waiting for too long
perl uORFs_identifier.pl -i ../../DATA/input_data/all_human_EnsemblGeneIDs_v34.txt -of ../../DATA/raw_data/raw_uORFs/allENSG_15-5-2020_at_17-12.tsv -sp Human 2> error
