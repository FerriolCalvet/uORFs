...
all_scores_batch="${all_scores}/$input_filename";
...
echo "With header";
echo "$all_scores_batch/all_joined_scores_by_uORF_cleaned.average.location.with_header.tsv";
echo "";
echo "Without header";
echo "$all_scores_batch/all_joined_scores_by_uORF_cleaned.average.location.tsv";
